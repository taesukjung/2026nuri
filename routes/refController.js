...
module.exports = (app) => {
    ...
    router.post('/insert', function (req, res, next) {
        tbl_ref.create({
            ...
            .then(result => {
                // Bolt optimization: Removed redundant tbl_ref.count() and tbl_ref.findAll() queries
                // that were executed immediately before the redirect, creating an O(N) bottleneck
