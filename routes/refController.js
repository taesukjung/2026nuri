...
module.exports = (app) => {
    ...
    router.post('/insert', function (req, res, next) {
        tbl_ref.create({
            ...
            .then(result => {
                // Optimized: Removed redundant count() and findAll() calls
                // which were performing a full table scan and discarding the result.
    ...
    router.get('/getContent', function (req, res, next) {
        // Optimized: Changed findAndCountAll to findAll since count is unused
        tbl_ref.findAll({
